          ...
          <div className="px-4 py-3 border-b border-zinc-200 dark:border-zinc-800 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex items-center gap-1.5 px-2 py-1 text-xs text-zinc-600 dark:text-zinc-400 hover:text-zinc-950 dark:hover:text-white rounded-md transition-colors"
              >
              ...
              <button
                ...
                className="p-1 text-zinc-600 dark:text-zinc-400 hover:text-zinc-950 dark:hover:text-white rounded transition-colors"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
          ...
          <div className="overflow-y-auto max-h-[50vh]">
            {isAnalyzing ? (
              ...
              <div className="p-4 text-center">
                ...
                <button
                  onClick={analyzeContent}
                  className="mt-2 text-sm text-zinc-600 dark:text-zinc-400 hover:text-zinc-950 dark:hover:text-white"
                >
                  Try again
                </button>
              </div>
