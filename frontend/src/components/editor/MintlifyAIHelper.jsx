            ...
            <div className="p-4 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <pre className="p-3 bg-slate-900 rounded-lg text-xs text-slate-400 overflow-x-auto max-h-48 overflow-y-auto">
                    {section.content.slice(0, 500)}{section.content.length > 500 ? '...' : ''}
                  </pre>
                </div>
                <div>
                  <div className="text-xs font-medium text-emerald-400 mb-2 flex items-center gap-2">
              ...
              <div className="flex items-center gap-2 justify-end">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 text-sm text-slate-400 hover:text-white rounded-lg hover:bg-slate-700 transition-colors"
                >
                  <X className="w-4 h-4" />
                  <span>Reject</span>
                </button>
...
export const MintlifyAIHelper = ({ content, onChange, onClose }) => {
  ...
  return (
    <div className="relative">
      ...
      {/* Flyout Panel */}
      {isOpen && (
        <div className="absolute top-full right-0 mt-2 w-[600px] max-h-[70vh] bg-slate-900 border border-slate-700 rounded-xl shadow-2xl overflow-hidden z-50">
          {/* Header */}
          <div className="px-4 py-3 border-b border-slate-700 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Sparkles className="w-5 h-5 text-amber-400" />
              <span className="font-semibold text-white">Mintlify Format Converter</span>
            </div>
            <div className="flex items-center gap-2">
              <button
          ...
          <div className="overflow-y-auto max-h-[50vh]">
            {isAnalyzing ? (
              <div className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-sm text-slate-400">Analyzing content for Mintlify patterns...</p>
              </div>
            ) : error ? (
              ...
              <div className="p-8 text-center">
                ...
                <p className="text-white font-medium">Content looks good!</p>
          ...
          {/* Footer */}
          {suggestionCount > 0 && (
            <div className="px-4 py-3 border-t border-slate-700 flex items-center justify-between bg-slate-800/50">
