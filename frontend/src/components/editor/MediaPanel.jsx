    ...
    <div className="h-full flex flex-col" data-testid="media-panel">
      ...
      <div className="px-4 py-3 border-b border-zinc-200 dark:border-zinc-800 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={fetchAssets}
            className="p-2 text-zinc-600 dark:text-zinc-400 hover:text-zinc-950 dark:hover:text-white rounded-md hover:bg-zinc-100 dark:hover:bg-zinc-800"
          >
        ...
        {selectedAsset && (
          <div className="w-64 border-l border-zinc-200 dark:border-zinc-800 p-4 overflow-auto">
            <div className="flex items-center justify-between mb-4">
              ...
              <button onClick={() => setSelectedAsset(null)} className="text-zinc-500 hover:text-zinc-950 dark:hover:text-white">
                <X className="w-4 h-4" />
              </button>
            </div>
