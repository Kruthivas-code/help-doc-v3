      ...
      <div className="px-4 py-3 border-b border-zinc-200 dark:border-zinc-800">
        {showCreateForm ? (
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-3 py-1.5 text-zinc-600 dark:text-zinc-400 hover:text-zinc-950 dark:hover:text-white text-sm"
              >
                Cancel
              </button>
            </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-3 py-2 border border-dashed border-zinc-200 dark:border-zinc-800 hover:border-zinc-300 dark:border-zinc-600 text-zinc-600 dark:text-zinc-400 hover:text-zinc-950 dark:hover:text-white rounded-lg transition-colors"
          >
                ...
                <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="flex items-center gap-1">
                    <button
                      ...
                      className="p-1.5 text-zinc-500 hover:text-zinc-950 dark:hover:text-white hover:bg-zinc-200 dark:bg-zinc-700 rounded transition-colors"
                      title="Preview"
                    >
