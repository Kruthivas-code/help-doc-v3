        ...
        >
            <div className="flex items-center justify-between px-4 py-2 bg-white dark:bg-zinc-900/70 border-b border-zinc-200 dark:border-zinc-800">
                ...
                <button
                    type="button"
                    onClick={handleCopy}
                    className="btn-press flex items-center gap-1.5 px-2 py-1 text-[11px] font-medium text-zinc-500 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-950 dark:hover:text-zinc-950 dark:text-white rounded transition-colors"
