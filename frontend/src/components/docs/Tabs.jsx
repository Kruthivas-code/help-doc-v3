          ...
          <button
            ...
            className={`px-4 py-2.5 text-sm font-medium whitespace-nowrap transition-colors border-b-2 -mb-px ${
              activeTab === index
                ...
                : 'text-zinc-500 dark:text-zinc-400 border-transparent hover:text-slate-900 dark:hover:text-zinc-950 dark:hover:text-zinc-950 dark:hover:text-white hover:border-zinc-300 dark:hover:border-zinc-300 dark:border-zinc-600'
            }`}
